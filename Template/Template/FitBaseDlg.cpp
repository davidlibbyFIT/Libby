#include "StdAfx.h"
#include "FitBaseDlg.h"

/**
* CLASS FitBaseDlg
*
* @brief FitBaseDlg Back Flush to clean
*
* @version 1.0 
*
* @author David Libby
...
*/
void FitBaseDlg::DoModeless(HWND hWndParent)
{
	if(!this->IsWindow())
...
* @param NewTop 
*/
void FitBaseDlg::SetOnTop(BOOL NewTop)
{
	m_OnTop=NewTop;
}
...
* @return LRESULT 
*/
LRESULT FitBaseDlg::OnInitDialog(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
...
* @return LRESULT 
*/
LRESULT FitBaseDlg::OnBnClickedCancel(WORD /*wNotifyCode*/, WORD /*wID*/, HWND /*hWndCtl*/, BOOL& /*bHandled*/)
{
	if (m_bModal)
		EndDialog(IDCANCEL);
	else
...
* @return LRESULT 
*/
LRESULT FitBaseDlg::OnBnClickedOk(WORD /*wNotifyCode*/, WORD /*wID*/, HWND /*hWndCtl*/, BOOL& /*bHandled*/)
{
	if (m_bModal)
		EndDialog(IDCANCEL);
	else
